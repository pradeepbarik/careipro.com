...
export async function generateMetadata({ searchParams }: { searchParams: any }): Promise<Metadata> {
    ...
    return {
        ...
        alternates:{
            canonical: `/${searchParams.state.toLowerCase().replace(" ", "-")}/${searchParams.city.toLowerCase().replace(/\s+/g, '-')}/${searchParams.seo_url}/${searchParams.page_type}-${searchParams.page_id}` // Relative path will be combined with metadataBase
        }
    }
}
