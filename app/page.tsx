...
export const metadata:Metadata={
  ...
  description:"Careipro, a Platform where you can find best doctors,clinic,hospital,medicine store,caretakers,masage service providers.All Things need for human health care and pet care like hospital,doctor,medicine,health tips,diet plans,disease awarness.peoples trusted platform careipro.com",
  alternates:{
    canonical:"/"
  },
  robots:{
