...
const nextConfig = {
    ...
    redirects: async () => {
        return [
            {
                source: '/:prefix-In-:city-(of|in)-:state',
                destination: '/:state/:city/:prefix',
                permanent: true,
                statusCode: 301
            },
            {
    ...
    rewrites: async () => {
        return [
            ...
            {
                source: '/:state/:city/(Physiotherapy-Centers|Physiotherapist|Physiotherapists|Best-Physiotherapy-Centers|Best-Physiotherapists)',
                destination: '/physiotherapy'
            },
            {
            ...
            {
                source: '/:state/:city/(Massage-Service-Spas|Massage-Services|Massage-Service|Best-Massage-Service-Spas|Best-Massage-Services)',
                destination: '/massage-service'
            },
            {
            ...
            {
                source: '/:state/:city/:business_type(doctor|physiotherapy|petcare)/:seo_url([a-zA-Z0-9-]+)-:service_loc_id([a-zA-Z0-9]+)',
                destination: '/doctors/doctor-detail'
            },
            {
